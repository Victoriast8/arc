...
/* package arc-0.1.0.0 */
#ifndef VERSION_arc
#define VERSION_arc "0.1.0.0"
#endif /* VERSION_arc */
#ifndef MIN_VERSION_arc
#define MIN_VERSION_arc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_arc */
...
#define CURRENT_COMPONENT_ID "arc-0.1.0.0-inplace-arc"
